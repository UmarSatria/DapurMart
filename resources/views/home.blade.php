...
<div class="flex justify-between max-w-4xl mx-auto">
    <div class="w-1/3 p-6 bg-blue-200 border border-blue-300 rounded-lg shadow">
    ...
    <div class="w-1/3 p-6 bg-green-200 border border-green-300 rounded-lg shadow">
    ...
    <div class="w-1/3 p-6 bg-purple-200 border border-purple-300 rounded-lg shadow">
