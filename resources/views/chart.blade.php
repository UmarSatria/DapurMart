                                    ...
                                    <form action="{{ route('chart.destroy', $item->id) }}" method="POST" class="p-4 md:p-5" enctype="multipart/form-data">
                                        ...
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                            <div class="col-span-2 ">
                                                <label for="barang_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Produk</label>
                                                <input type="text"  name="barang_id" id="barang_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 @error('barang_id') is-invalid @enderror"  value="{{$item->barang->nama_produk}}" readonly >
                                            </div>
                                            <div class="col-span-2 ">
                                            ...
                                            <div class="col-span-2">
                                                ...
                                                <div class="col-span-2 ">
                                                    ...
                                                    <input type="number" value="" name="no_telp" id="no_telp" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 @error('no_telp') is-invalid @enderror"  value="{{ old('no_telp') }}" placeholder="no telp" >
                                                    @error('no_telp')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
