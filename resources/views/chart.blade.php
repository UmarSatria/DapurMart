            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                                    ...
                                    <form  class="p-4 md:p-5">
                                        ...
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                            {{-- <div class="col-span-2">
                                                ...
                                                " class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="
                                                " required="">
                                            </div> --}}
                                            <div class="col-span-2">
                    ...
                    @endforeach
                        {{-- <!-- Tombol Checkout -->
                        <div class="mt-4">
                        <a href="" class=" block w-full md:max-w-xl text-center text-white bg-green-500 hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Checkout</a>
                        </div> --}}
